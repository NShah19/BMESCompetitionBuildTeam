...
/**
 * Created by nilay on 2/22/2018.
 */

public class BLECustomService {
    private static final String TAG = "BLECustomService";
    ...
    public final static UUID UUID_RX_CHAR =
            UUID.fromString("6E400003-B5A3-F393-E0A9-E50E24DCCA9E");
    public final static UUID UUID_TX_CHAR =
            UUID.fromString("6E400002-B5A3-F393-E0A9-E50E24DCCA9E");
    public final static UUID CCCD_UUID =
            UUID.fromString("000002902-0000-1000-8000-00805f9b34fb");

    private Context context;

    public BLECustomService(Context context) {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
                                         ...
                                         int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                onData(characteristic.getStringValue(0));
            }
        }
